...
namespace MyFoodDoc.App.Application.Services
{
    public class TargetService : ITargetService
    {
        ...
        public TargetService(IApplicationContext context, IFoodService foodService, IDiaryService diaryService, IOptions<StatisticsOptions> statisticsOptions, IMapper mapper)
        {
            _context = context;
