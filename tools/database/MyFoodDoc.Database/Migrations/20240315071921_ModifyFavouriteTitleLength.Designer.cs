...
namespace MyFoodDoc.Database.Migrations
{
    ...
    [Migration("20240315071921_ModifyFavouriteTitleLength")]
    partial class ModifyFavouriteTitleLength
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyFoodDoc.Application.Entities.Targets.Target", b =>
                {
                    ...
                    b.Property<bool?>("ZppSubscription")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("MyFoodDoc.Application.Entities.Subscriptions.AppStoreSubscription", b =>
                {
                    b.HasOne("MyFoodDoc.Application.Entities.User", "User")
                        .WithMany("AppStoreSubscriptions")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MyFoodDoc.Application.Entities.Subscriptions.GooglePlayStoreSubscription", b =>
                {
                    b.HasOne("MyFoodDoc.Application.Entities.User", "User")
                        .WithMany("GooglePlayStoreSubscriptions")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MyFoodDoc.Application.Entities.Targets.Target", b =>
                {
                    b.Navigation("AdjustmentTargets");
            ...
            modelBuilder.Entity("MyFoodDoc.Application.Entities.User", b =>
                {
                    ...
                    b.Navigation("AppStoreSubscriptions");

                    b.Navigation("Diets");

                    b.Navigation("Favourites");

                    b.Navigation("GooglePlayStoreSubscriptions");
