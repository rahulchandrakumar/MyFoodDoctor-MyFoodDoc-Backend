...
namespace MyFoodDoc.Database.Migrations
{
    ...
    [Migration("20191112070942_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyFoodDoc.Application.Entities.DiaryExercise", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyFoodDoc.Application.Entities.DiaryLiquid", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyFoodDoc.Application.Entities.DiaryMeal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyFoodDoc.Application.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "cd6b2420-21da-4848-9dac-178d17d8cc39",
                            Created = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEKRKfHgiaTciBr96xPOV/WGDBK9moLi1XQZ6vqeOb505Roh56zLnQ+Kpspt05qI31Q==",
            ...
            modelBuilder.Entity("MyFoodDoc.Application.Entities.DiaryMeal", b =>
                {
                    ...
                    b.OwnsMany("MyFoodDoc.Application.Entities.DiaryMealIngredient", "Ingredients", b1 =>
                        {
                            ...
                            b1.HasKey("MealId", "IngredientId");

                            b1.HasIndex("IngredientId");

                            b1.ToTable("MealsIngredients","Diary");

                            b1.HasOne("MyFoodDoc.Application.Entities.Ingredient", "Ingredient")
                                .WithMany()
